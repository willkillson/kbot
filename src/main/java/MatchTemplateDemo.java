...
//            System.exit(-1);
//        }
        img = Imgcodecs.imread("./images/haystack/haystack_a5_town_nearstash.png", Imgcodecs.IMREAD_COLOR);
        templ = Imgcodecs.imread("./images/needle/a5/a5_wp.jpg", Imgcodecs.IMREAD_COLOR);
        if (args.length > 2) {
            use_mask = true;
